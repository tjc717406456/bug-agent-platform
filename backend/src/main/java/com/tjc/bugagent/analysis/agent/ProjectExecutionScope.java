...
public final class ProjectExecutionScope {
    ...
    private ProjectExecutionScope(String taskId, Long ownerId, Long projectId, Long versionId,
                                  ProjectDatasource datasource, Set<String> allowedTools) {
        this.taskId = taskId;
        ...
        this.allowedTables = parseTables(datasource == null ? null : datasource.getWhitelistTables());
    ...
    public static ProjectExecutionScope create(String taskId, Long ownerId, Long projectId, Long versionId,
        ...
        return new ProjectExecutionScope(taskId, ownerId, projectId, versionId, datasource,
